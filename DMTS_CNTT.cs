...
{
    public partial class DMTS_CNTT : Form
    {
        ...
        private void DMTS_CNTT_Load(object sender, EventArgs e)
        {
        ...
        public void dulieu_DMTS()
        {
            ...
            dta = kn.Lay_Dulieu("Select MATAISAN,TENTAISAN,SOLUONG,STATUS from DMTAISAN WHERE MAPHONG='CNTT'");
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                sqltk = "Select * From DMTAISAN where MATAISAN like'%" + txtTimKiem.Text + "%' AND MAPHONG ='CNTT'";
                dta = kn.Lay_Dulieu(sqltk);
            }
            if (cbMucTK.Text == "Tên tài sản")
            {
                sqltk = "Select * From DMTAISAN where TENTAISAN like'%" + txtTimKiem.Text + "%'AND MAPHONG ='CNTT'";
                dta = kn.Lay_Dulieu(sqltk);
            }
            if (cbMucTK.Text == "Số lượng")
            {
                sqltk = "Select * From DMTAISAN where SOLUONG like'" + txtTimKiem.Text + "'AND MAPHONG ='CNTT'";
                dta = kn.Lay_Dulieu(sqltk);
            }
            if (cbMucTK.Text == "Tình Trạng")
            {
                sqltk = "Select * From DMTAISAN where STATUS like N'" + txtTimKiem.Text + "'AND MAPHONG ='CNTT'";
                dta = kn.Lay_Dulieu(sqltk);
            }
            dataGridViewCNTT.DataSource = dta;
        }
        ...
        private void dataGridViewCNTT_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
